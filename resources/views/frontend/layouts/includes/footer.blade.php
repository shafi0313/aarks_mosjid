            ...
            <div class="row g-3 justify-content-center g-lg-0">
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="footer-top-item lab-item">
                        <div class="lab-inner">
                            <div class="lab-thumb">
                                <img src="{{ asset('frontend/images/footer/footer-top/01.png') }}" alt="Phone-icon">
                            </div>
                ...
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="footer-top-item lab-item">
                        <div class="lab-inner">
                            <div class="lab-thumb">
                                <img src="{{ asset('frontend/images/footer/footer-top/02.png') }}" alt="email-icon">
                            </div>
                            <div class="lab-content">
                ...
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="footer-top-item lab-item">
                        <div class="lab-inner">
                            <div class="lab-thumb">
                                <img src="{{ asset('frontend/images/footer/footer-top/03.png') }}" alt="location-icon">
                            </div>
                            <div class="lab-content">
                        ...
                        <div class="footer-middle-item mb-5 mb-lg-0">
                            ...
                            <div class="fm-item-content">
                                <p class="mb-4">Energistically coordinate highly efficient procesr
                                    ...
                                    improvement</p>
                                <img src="{{ asset('frontend/images/footer/footer-middle/01.jpg') }}" alt="about-image"
                        ...
                        <div class="footer-middle-item mb-5 mb-lg-0">
                            ...
                            <div class="fm-item-content">
                                <div class="fm-item-widget lab-item">
                                    <div class="lab-inner">
                                        <div class="lab-thumb">
                                            <a href="#"> <img src="{{ asset('frontend/images/footer/footer-middle/02.jpg') }}"
                                ...
                                <div class="fm-item-widget lab-item">
                                    <div class="lab-inner">
                                        <div class="lab-thumb">
                                            <a href="#"><img src="{{ asset('frontend/images/footer/footer-middle/03.jpg') }}"
                                                    alt="footer-widget-img"></a>
                                        </div>
                                        <div class="lab-content">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="footer-bottom-content text-center">
                        <p>&copy;{{ date('Y') }} <a href="{{ route('index') }}">{{ Setting('app_name') }}</a></p>
                    </div>
                </div>
            </div>
        </div>
